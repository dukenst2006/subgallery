...
Route::get('/home/admin/users', 'Admin\UserController@index');
Route::get('/home/admin/roles', 'Admin\RoleController@index');
Route::get('/home/admin/permissions', 'Admin\PermissionController@index');
